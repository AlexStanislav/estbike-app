...
.load-bar {
  ...
  background: linear-gradient(var(--main 0 0) left -30px top 0/30px 20px no-repeat #ccc);
...
#second-spinner {
  ...
  border-left: 10px solid var(--dark-shade);
  border-right: 10px solid var(--dark-shade);
  border-radius: 100%;
  position: absolute;
